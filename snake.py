...
class Snake:
    def __init__(self):
        ...
        self.body = [[320, 260], [300, 260], [280, 260]]
        self.width = 20
        self.height = 20
        self.color = (144, 8, 26)
    ...
    def draw(self, surface):
        for segment in self.body:
            pygame.draw.rect(surface, self.color, (segment[0] + 1, segment[1]+1, self.width-2, self.height-2))    
            pygame.draw.rect(surface, (0, 0, 0), (segment[0], segment[1], self.width, self.height), 1)
